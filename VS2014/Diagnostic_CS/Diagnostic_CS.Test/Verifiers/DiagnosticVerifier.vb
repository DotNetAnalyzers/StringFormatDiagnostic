...
#Region " To be implemented by Test classes "
        ...
        ''' </summary>
        Protected Overridable Function GetCSharpDiagnosticAnalyzer() As IDiagnosticAnalyzer
            Return Nothing
        End Function
        ...
        ''' </summary>
        Protected Overridable Function GetBasicDiagnosticAnalyzer() As IDiagnosticAnalyzer
            Return Nothing
        End Function
#End Region
...
#Region " Verifier wrappers "
        ...
        ''' <param name="expected">DiagnosticResults that should appear after the analyzer Is run on the sources</param>
        Private Sub VerifyDiagnostics(sources As String(), language As String, analyzer As IDiagnosticAnalyzer, ParamArray expected As DiagnosticResult())
...
#Region " Actual comparisons And verifications "
        ...
        Private Shared Sub VerifyDiagnosticResults(actualResults As IEnumerable(Of Diagnostic), analyzer As IDiagnosticAnalyzer, ParamArray expectedResults As DiagnosticResult())
...
",
        ...
        Private Shared Sub VerifyDiagnosticLocation(analyzer As IDiagnosticAnalyzer, diagnostic As Diagnostic, actual As Location, expected As DiagnosticResultLocation)
...
#Region " Formatting Diagnostics "
        ...
        Private Shared Function FormatDiagnostics(analyzer As IDiagnosticAnalyzer, ParamArray diagnostics As Diagnostic()) As String
