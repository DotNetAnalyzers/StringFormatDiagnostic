...
'<ExportCodeFixProvider("VB_SFDCodeFixProvider", LanguageNames.VisualBasic), [Shared]>
'Public Class VB_SFDCodeFixProvider
'    Inherits CodeFixProvider

'    Public NotOverridable Overrides Function GetFixableDiagnosticIds() As ImmutableArray(Of String)
'        Return ImmutableArray.Create(VB_SFDAnalyzer.DiagnosticId)
'    End Function
