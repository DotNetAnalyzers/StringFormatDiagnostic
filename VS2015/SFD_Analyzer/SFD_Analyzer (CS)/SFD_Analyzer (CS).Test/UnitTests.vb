...
Imports SFD_Analyzer.Test.TestHelper
Imports Microsoft.CodeAnalysis
Imports Microsoft.CodeAnalysis.CodeFixes
Imports Microsoft.CodeAnalysis.Diagnostics
Imports Microsoft.VisualStudio.TestTools.UnitTesting

Namespace SFD_Analyzer.Test
  <TestClass>
...
End Module"
      Dim expected = New DiagnosticResult With {.Id = SFD_AnalyzerAnalyzer.DiagnosticId,
...
End Module"
    ...
    Protected Overrides Function GetBasicCodeFixProvider() As CodeFixProvider
      Return New SFD_AnalyzerCodeFixProvider()
    End Function

    Protected Overrides Function GetBasicDiagnosticAnalyzer() As DiagnosticAnalyzer
      Return New SFD_AnalyzerAnalyzer()
    End Function
