...
Namespace Global.SFD.Analysis.CS
  Public Class Checker
    ...
    Public Sub New(DA As IDiagnosticAnalyser, DI As DiagnosticInfo)
      A = DA
      I = DI
    End Sub
    ...
    'Public Sub AddError(I As DiagnosticInfo, id As String, msg As String, context As SyntaxNodeAnalysisContext, fs As TextSpan, sk As StringFormat.Span,
    ...
    'Public Sub AddHidden(I As DiagnosticInfo, id As String, msg As String, context As SyntaxNodeAnalysisContext, fs As TextSpan, sk As StringFormat.Span,
    '              Optional atSource As Boolean = False)
    '  Dim r As New DiagnosticDescriptor(id, "", msg, I.Cat, DiagnosticSeverity.Hidden, True)
    '  CreateDiagnosticReport(r, context, fs, If(atSource, New StringFormat.Span(sk.Source, 0, fs.Length), sk), msg)
    'End Sub

    'Public Sub AddInfo(I As DiagnosticInfo, id As String, msg As String, context As SyntaxNodeAnalysisContext, fs As TextSpan, sk As StringFormat.Span,
    '             Optional atSource As Boolean = False)
    ...
    Private Sub _Shared_Checker_(TheAnalyser As IDiagnosticAnalyser,
      ...
      Select Case ArgObjs.Count
        ...
        Case Is > 0
          ...
          If FormatTextArg Is Nothing Then Exit Sub
          Dim TheFormatString = FormatTextArg.Try(Of ArgumentSyntax)
    ...
    Private Sub _StringLiteral_(fn As IDiagnosticAnalyser,
                                ...
                                ArgObjs As IEnumerable(Of Object),
                                TheFormatString As ArgumentSyntax,
                                sk As Integer,
