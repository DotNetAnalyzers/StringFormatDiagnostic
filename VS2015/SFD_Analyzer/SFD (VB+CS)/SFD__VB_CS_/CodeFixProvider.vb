...
<ExportCodeFixProvider("SFD__VB_CS_CodeFixProvider", LanguageNames.VisualBasic), [Shared]>
Public Class SFD__VB_CS_CodeFixProvider
  Inherits CodeFixProvider

  Public NotOverridable Overrides Function GetFixableDiagnosticIds() As ImmutableArray(Of String)
    Return ImmutableArray.Create(SFD__VB_CS_Analyzer.DiagnosticId)
  End Function
