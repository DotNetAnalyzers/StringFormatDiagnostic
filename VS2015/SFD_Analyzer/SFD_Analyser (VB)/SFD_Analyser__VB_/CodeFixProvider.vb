...
'<ExportCodeFixProvider("SFD_AnalyzerCodeFixProvider", LanguageNames.VisualBasic), [Shared]>
'Public Class SFD_AnalyzerCodeFixProvider
'  Inherits CodeFixProvider

'  Public NotOverridable Overrides Function GetFixableDiagnosticIds() As ImmutableArray(Of String)
'    Return ImmutableArray.Create(SFD_AnalyzerAnalyzer.DiagnosticId)
'  End Function
